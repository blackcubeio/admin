...
class Rbac
{
    ...
    public const PERMISSION_CATEGORY_IMPORT = 'CATEGORY:IMPORT';
    public const PERMISSION_CATEGORY_EXPORT = 'CATEGORY:EXPORT';
    ...
    public const PERMISSION_NODE_IMPORT = 'NODE:IMPORT';
    public const PERMISSION_NODE_EXPORT = 'NODE:EXPORT';
    ...
    public const PERMISSION_COMPOSITE_IMPORT = 'COMPOSITE:IMPORT';
    public const PERMISSION_COMPOSITE_EXPORT = 'COMPOSITE:EXPORT';
