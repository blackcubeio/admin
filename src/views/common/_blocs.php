        ...
        <div class="element-form-bloc-wrapper">
            <div class="element-form-bloc">
                <h3 class="element-form-bloc-title">
                    <?php echo preg_replace('/[0-9]+\.\s*/', '', $bloc->blocType->name); ?>
                </h3>
                    ...
                    <span class="element-form-bloc-toolbar-buttons">
                        <?php if ($element->type && $element->type->getBlocTypes()->count() > 0): ?>
                            <span class="relative z-0 inline-flex shadow-sm rounded-md">
                                <?php echo Html::dropDownList('blocTypeId', null, ArrayHelper::map($element->type->getBlocTypes()->orderBy(['name' => SORT_ASC])->all(), 'id', function($model) { return preg_replace('/[0-9]+\.\s*/', '', $model->name); }), [
