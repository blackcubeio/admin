 ...
 * @package blackcube\admin\import\node
 *
 * @var $jsonData array
...
<main class="application-content">
    ...
    <div class="page-header">
        ...
        <p class="element-form-header-abstract"><?php echo Module::t('import', 'This is the node which will be imported'); ?></p>
    </div>
    <div class="px-6 pb-6">
        ...
        <div class="element-form-bloc">
            <div class="element-form-bloc-stacked">
                <?php echo BlackcubeHtml::checkbox('active', $jsonData['active'] , [
                    'hint' => Module::t('import', 'Node status'),
                    'label' => Module::t('import', 'Node active'),
                    'disabled' => 'disabled'
                ]); ?>
            </div>
        ...
        <?php if ($pluginsHandler instanceof PluginsHandlerInterface): ?>
            <?php $widgets = $pluginsHandler->runWidgetHook(
                $node->isNewRecord ? PluginManagerAdminHookInterface::PLUGIN_HOOK_WIDGET_COMPOSITE_CREATE_TAIL : PluginManagerAdminHookInterface::PLUGIN_HOOK_WIDGET_COMPOSITE_UPDATE_TAIL,
                $node
            ); ?>
