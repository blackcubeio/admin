...
?>
    <main class="application-content">
        <?php if ($pluginsHandler instanceof PluginsHandlerInterface): ?>
            <?php $widgets = $pluginsHandler->runWidgetHook(PluginManagerAdminHookInterface::PLUGIN_HOOK_WIDGET_COMPOSITE_LIST_HEAD); ?>
        ...
        <?php if ($pluginsHandler instanceof PluginsHandlerInterface): ?>
            <?php $widgets = $pluginsHandler->runWidgetHook(PluginManagerAdminHookInterface::PLUGIN_HOOK_WIDGET_COMPOSITE_LIST_BEFORE_LIST); ?>
            <?php foreach ($widgets as $widget): ?>
                <?php echo $widget; ?>
            <?php endforeach; ?>
        <?php endif; ?>
        ...
        <?php echo Html::endForm(); ?>
        <?php if ($pluginsHandler instanceof PluginsHandlerInterface): ?>
            <?php $widgets = $pluginsHandler->runWidgetHook(PluginManagerAdminHookInterface::PLUGIN_HOOK_WIDGET_COMPOSITE_LIST_AFTER_LIST); ?>
            <?php foreach ($widgets as $widget): ?>
                <?php echo $widget; ?>
            <?php endforeach; ?>
        <?php endif; ?>
